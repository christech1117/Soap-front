  ...
  <div class="singleItem">
    ...
    <div class="container">
      ...
      <ol class="breadcrumb">
        ...
        <li><router-link :to="{ path: '/' }">商品列表</router-link></li>
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="row">
            <div class="col-md-6">
              <img src="https://unsplash.it/1080/1080?image=0" alt="">
            </div>
            <div class="col-md-6">
              <h2>身活保濕乳</h2>
              ...
              <router-link :to="{ path: '/forget' }"><button type="button" class="btn">加入購物車</button></router-link>
              <router-link :to="{ path: '/forget' }"><button type="button" class="btn">加入下次再買</button></router-link>
            </div>
            <div class="col-md-12">
              <p>重現「活力」身活！<br>
                  感覺需要「保養」嗎？<br>
            ...
            <div class="col-md-12">
              <img src="https://www.teasoap.com.tw/downloads/image/pdb/SHENHUO_003_1.png" alt="">
            </div>
            <div class="col-md-12">
              <p>身活所需是保濕，豐潤柔滑的質地，搭配多種天然萃取的保濕因子，藉由水份的滋潤與油分的薄膜，可降低微小紋路生成，使肌膚柔嫩細緻，添加蘭花萃取能協助肌膚代謝作用，讓肌膚保持彈性，搭配天然有機阿甘果油，可深層滋養乾燥的肌膚，水解小麥蛋白能保護肌膚，提升對外在環境的防護力，而獨特雪滴花萃取，具有延緩老化效果，使肌膚更加活力明亮，適合乾性膚質及一般膚質舒緩保濕使用。</p>
            </div>
            <div class="col-md-12">
              <img src="https://www.teasoap.com.tw/downloads/image/pdb/SHENHUO_004_1.png" alt="">
            </div>
          </div>
        </div>
      </div>
