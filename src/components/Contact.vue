<template>
  <div class="contact">
    ...
    <div class="section-header">
      <h1><i class="fa fa-phone fa" aria-hidden="true"></i>聯絡我們</h1>
    </div>
    <ol class="breadcrumb">
    ...
    -->
      ...
      <form action="">
        ...
        <router-link :to="{ path: '/contact' }"><button type="submit" class="btn">送出</button></router-link>
      </form>
    </div>
  </div>
</template>
