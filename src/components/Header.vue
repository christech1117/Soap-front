    ...
    <div class="container">
      ...
      <div id="navheader" class="collapse navbar-collapse">
        <ul class="nav navbar-nav navbar-right">
          <!-- <router-link :to="{ name: 'FirstId', params: { id: 123 }}">First 123</router-link> -->
            <li @click=""><a href="#">會員登入</a></li>
            <li><a href="#">最新消息</a></li>
            <li><a href="#">熱門活動</a></li>
            <li>
              <router-link :to="{ name: 'Product' }">商品介紹</router-link>
            </li>
            <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">購物須知 <b class="caret"></b></a>
